...
c trich13a has increments in denssities after particle rates
...
c Add Diffusion of electrons; diff coefficient = diffelect
     ...
     r    +(fdifer-bdifer)/dr(j))
          ...
          if (j.eq.20.and.i.eq.1)
     r         write(*,*) j,i,diffel,rion,att,rece,det,rne(j,i)
          if (j.eq.20.and.i.eq.1)
     r         write(*,*) detach,rnm(j,i),rni(j,i) 
