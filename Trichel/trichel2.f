...
c Trichel modification - ions and electrons impinging on cathode are absorbed
          if (i.eq.33.and.rjniz(j,i).le.0.0) rjniz(j,32) = rjniz(j,33)
          if (i.eq.33.and.rjnez(j,i).le.0.0) rjnez(j,32) = rjnez(j,33)
          if (i.eq.33.and.rjnpz(j,i).le.0.0) rjnpz(j,32) = rjnpz(j,33)
...
c make under surface at i=32 conducting
	  if (i.eq.33.and.rjnpz(j,i).le.0.0) rjnpz(j,i-1)=rjnpz(j,i)
